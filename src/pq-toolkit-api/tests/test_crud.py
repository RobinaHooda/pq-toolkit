                ...
                "tests": [
                    {
                        ...
                        "type": "ACR",
                        "samples": [
                            {"sampleId": "s1", "assetPath": "sample-12s.mp3"},
                            {"sampleId": "s2", "assetPath": "sample-15s.mp3"},
                            {"sampleId": "s4", "assetPath": "file_sample_700.mp3"},
                            {"sampleId": "s3", "assetPath": "file_sample_5.mp3"},
                        ],
                    }
                ],
            },
